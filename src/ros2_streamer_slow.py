...
class ROS2Streamer(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('max_arm_joint_change_rad', 0.01)  # Maximum change in radians per update for arm joints
        self.declare_parameter('max_hand_joint_change_rad', 200)  # Maximum change in radians per update for hand joints
        self.declare_parameter('max_neck_joint_change_rad', 0.01)  # Maximum change in radians per update for neck joints
